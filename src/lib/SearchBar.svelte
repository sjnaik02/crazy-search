...
<div class="wrapper">
  <img src={`src/static/${searchEngine ? searchEngine : defaultSearchEngine}.svg`} alt="search term icon" class="icon">
  <input bind:value={search} on:keydown={handleKeyDown}>
  <button on:click={handleClick}><img src="src/static/angles-right.svg" alt="Right arrows"></button>
</div>
<span>
